...
class BatchNormSPD(nn.Module):
    ...
    def __init__(self, n, po=1):
        ...
        self.weight = functional.SPDParameter(eyes)
        self.M = functional.SPDParameter(th.eye(n, n, dtype=dtype, device=device))
    ...
    def forward(self, X):
        ...
        X_normalized = functional.ExpG(functional.pal2(weight, functional.LogG1(X_centered)), weight)
